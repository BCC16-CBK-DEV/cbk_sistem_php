...
<div class="posicao_conteudo">
	...
	<h4 class="titulo_opcoes"><span class="fa fa-archive"></span> Consultar OS</h4>
	<hr class="linha_nova_ordem">
	<div class="barra_pesquisa row">
		<button class="btn btn-primary" id="botaoFiltro" type="button" data-toggle="collapse" aria-expanded="false" aria-controls="collapseFiltro">
			Filtros
			</button>
	</div>
